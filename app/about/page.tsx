...
export const metadata: Metadata = {
  title: "About",
  description: "This is all about Arjun Varshney",
};
...
const AnimateNumbers = ({ value }: animateNumberProps) => {
        ...
        <Layout>
          ...
          <div className="grid w-full grid-cols-8 gap-16 sm:gap-8">
            ...
            <div className="col-span-3 relative h-max rounded-2xl border-2 border-solid border-dark bg-light p-8 xl:col-span-4 md:order-1 md:col-span-8">
              <div className="absolute top-0 -right-3 -z-10 w-[102%] h-[103%] rounded-[2rem] rounded-br-3xl bg-dark " />
              <Image
                src={profilePic}
                alt="Arjun Varshney"
